...
func writeGoMetrics(w io.Writer) {
	...
	WriteMetadataIfNeeded2(w, "go_info", "Information about the Go environment.", "gauge")
	fmt.Fprintf(w, "go_info{version=%q} 1\n", runtime.Version())

	WriteMetadataIfNeeded2(w, "go_info_ext", "Extended information about the Go environment.", "gauge")
